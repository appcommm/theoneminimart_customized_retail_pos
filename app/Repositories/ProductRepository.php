    ...
    public function storeProduct($input)
    {
        ...
        if (isset($input['purchase_quantity'])) {
            $purchaseStock = [
                ...
                'box_per_qty' => $input['box_per_qty'],
                'box_per_price' => $input['box_per_price'],
                'box_per_purchase_cost' => $input['box_per_purchase_cost']
            ];
            ...
            if ($purchaseStock) {
                ...
                $purchaseItemArr = [
                    ...
                    'box_per_qty' => $purchaseStock['box_per_qty'],
                    'box_per_price' => $purchaseStock['box_per_price'],
                    'box_per_purchase_cost' => $purchaseStock['box_per_purchase_cost']
                ];
