...
class PurchaseItem extends BaseModel implements JsonResourceful
{
    ...
    public static $rules = [
        ...
        'box_per_qty' => 'nullable|numeric',
        'box_per_price' => 'nullable|numeric',
        'box_per_purchase_cost' => 'nullable|numeric'
    ];
    ...
    public function prepareAttributes(): array
    {
        $fields = [
            ...
            'unit' => $this->unit,
            'box_per_qty' => $this->box_per_qty,
            'box_per_price' => $this->box_per_price,
            'box_per_purchase_cost' => $this->box_per_purchase_cost
