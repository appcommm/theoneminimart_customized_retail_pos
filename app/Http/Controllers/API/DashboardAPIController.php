...
class DashboardAPIController extends AppBaseController
{
    ...
    public function getTotalSaleByPaymentType(): JsonResponse {
        $data = Sale::select('payment_type', DB::raw('SUM(grand_total) as grand_total'))
        ->groupBy('payment_type')
        ->get();
        return $this->sendResponse($data, 'Total Sale By Payment Type Retrieved Successfully');
    }
