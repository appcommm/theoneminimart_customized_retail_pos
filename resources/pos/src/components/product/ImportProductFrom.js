                        ...
                        <div className='col-md-12'>
                            <table className="table table-bordered table-sm mt-4">
                                <tbody className='fw-normal'>
                                    ...
                                    <tr>
                                        <td>{getFormattedMessage("product.input.barcode-symbology.label")}</td>
                                        <td><span className='badge bg-light-primary'><span>{getFormattedMessage("globally.require-input.validate.label")}</span></span></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td>{getFormattedMessage("product.product-details.product_type.label")}</td>
                                        <td><span className='badge bg-light-success'><span>{getFormattedMessage("globally.optional-input.validate.label")}</span></span></td>
                                    </tr>
                                    <tr>
                                        <td>{getFormattedMessage("product.product-details.variation.label")}</td>
                                        <td><span className='badge bg-light-success'><span>{getFormattedMessage("globally.optional-input.validate.label")}</span></span></td>
                                    </tr>
                                    <tr>
                                        <td>{getFormattedMessage("product.product-details.variation_type.label")}</td>
                                        <td><span className='badge bg-light-success'><span>{getFormattedMessage("globally.optional-input.validate.label")}</span></span></td>
                                    </tr>
                                </tbody>
                            </table>
