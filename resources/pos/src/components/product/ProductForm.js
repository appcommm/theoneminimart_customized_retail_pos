    ...
    const validateVariationTypesData = () => {
        ...
        variationTypesData.map((variationType) => {
            if (
                ...
                Object.keys(error).length <= 0 &&
                (!variationType.box_per_qty || variationType.box_per_qty === "")
            ) {
                error[`${variationType.variation_type_id}_box_per_qty`] =
                    getFormattedMessage("Enter box per qty");
            } else if (
                Object.keys(error).length <= 0 &&
                (!variationType.box_per_price ||
                    variationType.box_per_price === "")
            ) {
                error[`${variationType.variation_type_id}_box_per_price`] =
                    getFormattedMessage("Enter price per box");
            } else if (
                Object.keys(error).length <= 0 &&
                (!variationType.box_per_purchase_cost ||
                    variationType.box_per_purchase_cost === "")
            ) {
                error[
                    `${variationType.variation_type_id}_box_per_purchase_cost`
                ] = getFormattedMessage("Enter purchase cost per box");
            } else if (
                Object.keys(error).length <= 0 &&
    ...
    const handleValidation = () => {
        ...
        if (!productValue["name"] || productValue["name"].trim() === "") {
            ...
            if (
                ...
                productValue.product_type.value === 1 &&
                (!singleProductTypeData.box_per_qty ||
                    singleProductTypeData.box_per_qty === "")
            ) {
                errorss["box_per_qty"] =
                    getFormattedMessage("Enter box per qty");
                ...
                productValue.product_type.value === 1 &&
                (!singleProductTypeData.box_per_price ||
                    singleProductTypeData.box_per_price === "")
            ) {
                errorss["box_per_price"] = getFormattedMessage(
                    "Enter price per box "
                );
            } else if (
                productValue.product_type.value === 1 &&
                (!singleProductTypeData.box_per_purchase_cost ||
                    singleProductTypeData.box_per_purchase_cost === "")
            ) {
                errorss["box_per_purchase_cost"] = getFormattedMessage(
                    "Enter purchase cost per box"
                );
                ...
                formData.append(
                    ...
                    JSON.stringify(
                        variationTypesData.map((variationType) => ({
                            ...
                            box_per_qty: variationType.box_per_qty,
                            box_per_price: variationType.box_per_price,
                            box_per_purchase_cost:
                                variationType.box_per_purchase_cost,
                                    ...
                                    {!singleProduct && (
                                        <div className="col-md-3 mb-3">
                                            ...
                                            <input
                                                ...
                                                value={variation.box_per_qty}
                                                min={1}
                                            />
                                            <span className="text-danger d-block fw-400 fs-small mt-2">
                                                {errors[
                                                    `${variation.variation_type_id}_box_per_qty`
                                                ]
                                                    ? errors[
                                                          `${variation.variation_type_id}_box_per_qty`
                                                      ]
                                    ...
                                    {!singleProduct && (
                                        <div className="col-md-3 mb-3">
                                            ...
                                            <input
                                                ...
                                                value={variation.box_per_price}
                                                min={1}
                                            />
                                            <span className="text-danger d-block fw-400 fs-small mt-2">
                                                {errors[
                                                    `${variation.variation_type_id}_box_per_price`
                                                ]
                                                    ? errors[
                                                          `${variation.variation_type_id}_box_per_price`
                                                      ]
                                    ...
                                    {!singleProduct && (
                                        <div className="col-md-3 mb-3">
                                            ...
                                            <input
                                                ...
                                                value={
                                                    variation.box_per_purchase_cost
                                                }
                                                min={1}
                                            />
                                            <span className="text-danger d-block fw-400 fs-small mt-2">
                                                {errors[
                                                    `${variation.variation_type_id}_box_per_purchase_cost`
                                                ]
                                                    ? errors[
                                                          `${variation.variation_type_id}_box_per_purchase_cost`
                                                      ]
