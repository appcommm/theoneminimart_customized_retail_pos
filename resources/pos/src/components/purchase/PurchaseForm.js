...
const PurchaseForm = (props) => {
    ...
    const [purchaseValue, setPurchaseValue] = useState({
        date: singlePurchase
            ? moment(singlePurchase.date).toDate()
            : new Date(),
        ...
        status_id: singlePurchase
            ? singlePurchase.status_id
            : {
    ...
    const prepareData = (prepareData) => {
        const formValue = {
            ...
            grand_total: calculateCartTotalAmount(
                updateProducts,
                purchaseValue
            ),
            received_amount: "",
                        ...
                        <Table responsive>
                            <thead>
                                <tr>
                                    ...
                                    <th>{getFormattedMessage("Unit")}</th>
                                    <th className="text-lg-start text-center">
                                        {getFormattedMessage(
