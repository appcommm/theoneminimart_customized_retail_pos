...
const Sales = (props) => {
    ...
    const itemsValue =
        ...
        selectedData.map((sale) => ({
            date: getFormattedDate(
                sale.created_at,
                allConfigData && allConfigData
            ),
            // date_for_payment: sale.date,
            time: moment(sale.created_at).format("LT"),
            ...
            paid_amount: sale.paid_amount ? sale.paid_amount : (0.0).toFixed(2),
            id: sale.id,
