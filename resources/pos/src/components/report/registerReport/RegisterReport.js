...
const RegisterReport = () => {
    ...
    const [closed_at, setColsed_at] = useState(null);
    const [opened_at, setOpened_at] = useState(null);
    ...
    const onReportsClick = (item) => {
        ...
        setColsed_at(item?.closed_at);
        setOpened_at(item?.opened_at);
        setSelectedData(item?.sales);
        setSaleOpen(true);
    };
    ...
    const itemsValue =
        ...
        registerReportDetails?.map((registerReport) => ({
            ...
            closed_at: registerReport?.attributes?.closed_at,
            opened_at: registerReport?.attributes?.created_at,
            ...
            sales: registerReport?.attributes?.sales,
        }));
