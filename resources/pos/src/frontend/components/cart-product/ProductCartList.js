...
const ProductCartList = (props) => {
    ...
    console.log(singleProduct, "singpd");
            ...
            updateProducts.map((item) => {
                if (item.id === singleProduct.id) {
                    if (obj.value === 2) {
                        return {
                            ...item,
                            net_unit_cost: item.box_per_price,
                            unit: obj.value,
                            fix_product_price: item.product_price,
                            product_price: item.box_per_price,
                        };
                    }
                    if (obj.value === 1) {
                        ...
                        return {
                            ...item,
                            net_unit_cost: singleProduct.product_price || 0,
                            unit: obj.value,
                            product_price: singleProduct.fix_product_price,
                        };
                    }
                }
                return item;
        ...
        <tr key={index} className="align-middle">
            ...
            <td>
                <ReactSelect
                    ...
                    onChange={(obj) => onMethodChangeFinalProduct(obj, index)}
