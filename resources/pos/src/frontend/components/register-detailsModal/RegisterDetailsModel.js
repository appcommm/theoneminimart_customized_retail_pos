...
function RegisterDetailsModel(props) {
    ...
    useEffect(() => {
        if (closeRegisterDetails?.sale_items) {
            // Ensure sale_items exists
            setSelectedData(closeRegisterDetails.sale_items);
        }
            ...
            >
                ...
                <Modal.Body>
                    {selectedData.length > 0 && (
                        <div className="mb-6 registerModel text-nowrap">
                            <Sale selectedData={selectedData} />
                        </div>
                    )}
                    <Table
                        responsive
