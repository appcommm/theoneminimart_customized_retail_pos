...
const ProductTableBody = (props) => {
    ...
    console.log(singleProduct, "singleProduct product table");
    ...
    //             updateProducts.map((item) =>
    //                 item.id === singleProduct.id
    //                     ? { ...item, fix_net_unit: item.box_per_price }
    //                     : item
    //             )
    //         );
    //     }
    ...
    //             updateProducts.map((item) =>
    //                 item.id === singleProduct.id
    //                     ? { ...item, fix_net_unit: item.fix_net_unit }
    //                     : item
    //             )
    //         );
    //     }
            ...
            updateProducts.map((item) => {
                if (item.id === singleProduct.id) {
                    if (obj.value === 2) {
                        return {
                            ...item,
                            fix_net_unit: item.box_per_price,
                            unit: obj.value,
                        };
                    }
                    if (obj.value === 1) {
                        ...
                        return {
                            ...item,
                            fix_net_unit: singleProduct.product_price || 0,
                            unit: obj.value,
                        };
                    }
                }
            ...
            <tr key={index} className="align-middle text-nowrap">
                ...
                <td>
                    ...
                    {/* {currencySymbolHandling(
                        ...
                        frontSetting.value &&
                            frontSetting.value.currency_symbol,
                        subTotalCountPerBox(singleProduct)
                    )} */}
                </td>
