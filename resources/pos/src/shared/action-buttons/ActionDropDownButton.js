    ...
    return (
        <Dropdown className="table-dropdown">
            ...
            <Dropdown.Menu>
                ...
                {config &&
                config.includes(Permissions.MANAGE_SALE_RETURN_CREATE) &&
                isCreateSaleReturn &&
                item.is_return !== 1 ? (
                    <Dropdown.Item
                        onClick={(e) => {
                    ...
                    >
                        <FontAwesomeIcon
                            ...
                            className="me-2"
                        />
                        {getFormattedMessage("sale-return.create.title")}
                        {/*{getFormattedMessage('globally.show.payment.label')}*/}
                    </Dropdown.Item>
                ) : null}
                {(config &&
                    config.includes(Permissions.MANAGE_SALE_RETURN_EDIT) &&
                    item.is_return === 1) ||
                (SaleReturn &&
                    config &&
                    config.includes(Permissions.MANAGE_SALE_RETURN_EDIT)) ? (
                    ...
                    >
                        <FontAwesomeIcon
                            ...
                            className="me-2"
                        />
                        {getFormattedMessage("sale-return.edit.title")}
                        {/*{getFormattedMessage('globally.show.payment.label')}*/}
                    </Dropdown.Item>
                ) : null}
                {config &&
                    config.includes(Permissions.MANAGE_SALE_EDIT) &&
                    goToEditProduct &&
                    !SaleReturn &&
                    ...
                    item.is_return !== 1 && (
                        ...
                        >
                            <FontAwesomeIcon
                                ...
                                className="me-2"
                            />
                            {getFormattedMessage("globally.edit.tooltip.label")}{" "}
                            {title}
                        </Dropdown.Item>
                    )}
                {config &&
                    config.includes(Permissions.MANAGE_SALE_RETURN_DELETE) &&
                    SaleReturn && (
                        <Dropdown.Item
                            onClick={(e) => {
                                e.stopPropagation();
                ...
                {config &&
                    config.includes(Permissions.MANAGE_SALE_DELETE) &&
                    !SaleReturn && (
                        <Dropdown.Item
                            onClick={(e) => {
                                e.stopPropagation();
