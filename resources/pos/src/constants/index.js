...
export const apiBaseURL = {
    ...
    TOTAL_SALE_BY_PAYMENT_TYPE: "total-sale-by-payment-type",
...
export const totalSaleByPaymentTypeActionType = {
    TOTAL_SALE_BY_PAYMENT_TYPE: "TOTAL_SALE_BY_PAYMENT_TYPE",
    TOTAL_SALE_BY_PAYMENT_REPORT: "TOTAL_SALE_BY_PAYMENT_TYPE_REPORT",
};
...
export const Permissions = {
    ...
    MANAGE_SALE_CREATE: "create_sale",
    MANAGE_SALE_EDIT: "edit_sale",
    MANAGE_SALE_DELETE: "delete_sale",
    MANAGE_SALE_RETURN: "manage_sale_return",
    MANAGE_SALE_RETURN_CREATE: "create_sale_return",
    MANAGE_SALE_RETURN_EDIT: "edit_sale_return",
    MANAGE_SALE_RETURN_DELETE: "delete_sale_return",
    ...
    REPORT_TOP_SELLING_PRODUCTS: "report_top_selling_products",
    REPORT_PRODUCT_QUANTITY: "report_product_quantity",
    REPORT_SUPPLIERS: "report_suppliers",
    REPORT_PROFIT_LOSS: "report_profit_loss",
    REPORT_BEST_CUSTOMERS: "report_best_customers",
...
export const paymentMethodOptions = [
    ...
    { id: 5, name: "payment-type.filter.kpay.label" },
];
